...
3. Секретные ключи в коде - **пробовала через Environment Variables выдает при запросе  (Unauthorized),убила кучу времени, ответ не нашла, если не сложно наведите на мысль в каком направлении искать решение**
